...
const Terms = (props) => {
    ...
    const getTerm = () => {
        PrivacyService.getTerm().then((response) => {
    ...
    const handleSubmitEditor = () => {
        if (quill) {
            ...
            PrivacyService.editTerm(quill.root.innerHTML).then(response => {
    ...
    return (
        <RouteGuard>
            <div className="main-page main-page--terms">
                <Sidebar
                    isMenuActive="terms_of_service"
...
const defaultHtml = `<div className="terms__inner">
    <h1>Ｂｙｍｅ利用規約</h1>
    <p>
