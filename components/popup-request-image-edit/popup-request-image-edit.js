...
const PopupRequestImageEdit = (props) => {
    const {
        t,
        data,
        url,
    ...
    const validationSchema = yup.object().shape({
        note: yup
            .string()
            .required(t("photo_note_valid_empty"))
            .typeError(t("photo_note_valid_empty")),
    });
    ...
    return (
        <div
            className={`popup__list popup__list--admin-request-edit ${
                isOpen ? "active" : ""
            }`}
        >
            <div className={`popup__item relative ${isOpen ? "active" : ""}`}>
                <div className="popup__item-inner">
                    <div
                        className="popup__close f jce aic"
                        ...
                        <div className="popup__content">
                            ...
                            <div className="form-group">
                                ...
                                <div className="popup__actions f jcc aic">
                                    <button
                                        type="button"
                                        className="popup__btn-save btn btn-default btn--no-shadow btn--small"
...
export default PopupRequestImageEdit;
